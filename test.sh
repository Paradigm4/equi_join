...
iquery -aq "sort(equi_join(left, right, 'left_ids=~0', 'right_ids=1', 'algorithm=merge_left_first',    'keep_dimensions=TRUE'), i,a,b,c)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(left, right, 'left_ids=~0', 'right_ids=1', 'algorithm=merge_right_first',   'keep_dimensions=TRUE'), i,a,b,c)" >> $OUTFILE 2>&1
