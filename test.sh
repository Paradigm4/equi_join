...
iquery -aq "sort(equi_join(left, right, left_ids:'0', right_ids:'0', algorithm:'hash_replicate_right', keep_dimensions:true                                    ), a,b,d)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(left, right, left_ids:'0', right_ids:'0', algorithm:'hash_replicate_left',  keep_dimensions:true                                    ), a,b,d)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(left, right, left_ids:'0', right_ids:'0', algorithm:'merge_left_first',     keep_dimensions:true                                    ), a,b,d)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(left, right, left_ids:'0', right_ids:'0', algorithm:'merge_right_first',    keep_dimensions:true                                    ), a,b,d)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(left, right, left_ids:'0', right_ids:'0', algorithm:'merge_left_first',     keep_dimensions:true,    hash_join_threshold:0        ), a,b,d)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(left, right, left_ids:'0', right_ids:'0', algorithm:'merge_right_first',    keep_dimensions:true,    hash_join_threshold:0        ), a,b,d)" >> $OUTFILE 2>&1
...
iquery -aq "sort(equi_join(right, left, left_ids:'0', right_ids:'0', algorithm:'hash_replicate_right', keep_dimensions:true                                    ), c,d,b)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'0', right_ids:'0', algorithm:'hash_replicate_left',  keep_dimensions:true                                    ), c,d,b)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'0', right_ids:'0', algorithm:'merge_left_first',     keep_dimensions:true                                    ), c,d,b)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'0', right_ids:'0', algorithm:'merge_right_first',    keep_dimensions:true                                    ), c,d,b)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'0', right_ids:'0', algorithm:'merge_left_first',     keep_dimensions:true,    hash_join_threshold:0        ), c,d,b)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'0', right_ids:'0', algorithm:'merge_right_first',    keep_dimensions:true,    hash_join_threshold:0        ), c,d,b)" >> $OUTFILE 2>&1
...
iquery -aq "equi_join(left, right, left_ids:'0,~0', right_ids:'0,~0', algorithm:'hash_replicate_right', keep_dimensions:true                                           )" >> $OUTFILE 2>&1
iquery -aq "equi_join(left, right, left_ids:'0,~0', right_ids:'0,~0', algorithm:'hash_replicate_left',  keep_dimensions:true                                           )" >> $OUTFILE 2>&1
iquery -aq "equi_join(left, right, left_ids:'0,~0', right_ids:'0,~0', algorithm:'merge_left_first',     keep_dimensions:true                                           )" >> $OUTFILE 2>&1
iquery -aq "equi_join(left, right, left_ids:'0,~0', right_ids:'0,~0', algorithm:'merge_right_first',    keep_dimensions:true                                           )" >> $OUTFILE 2>&1
iquery -aq "equi_join(left, right, left_ids:'0,~0', right_ids:'0,~0', algorithm:'merge_left_first',     keep_dimensions:true,   hash_join_threshold:0                )" >> $OUTFILE 2>&1
iquery -aq "equi_join(left, right, left_ids:'0,~0', right_ids:'0,~0', algorithm:'merge_right_first',    keep_dimensions:true,   hash_join_threshold:0                )" >> $OUTFILE 2>&1

echo " " >> $OUTFILE 2>&1
echo "Chapter 4" >> $OUTFILE 2>&1
iquery -aq "equi_join(right, left, left_ids:'~0,0', right_ids:'~0,0'                                                                                                  )" >> $OUTFILE 2>&1
iquery -aq "equi_join(right, left, left_ids:'~0,0', right_ids:'~0,0', algorithm:'hash_replicate_right', keep_dimensions:false                                           )" >> $OUTFILE 2>&1
iquery -aq "equi_join(right, left, left_ids:'~0,0', right_ids:'~0,0', algorithm:'hash_replicate_left',  keep_dimensions:false                                           )" >> $OUTFILE 2>&1
iquery -aq "equi_join(right, left, left_ids:'~0,0', right_ids:'~0,0', algorithm:'merge_left_first',     keep_dimensions:false                                           )" >> $OUTFILE 2>&1
iquery -aq "equi_join(right, left, left_ids:'~0,0', right_ids:'~0,0', algorithm:'merge_right_first',    keep_dimensions:false                                           )" >> $OUTFILE 2>&1
iquery -aq "equi_join(right, left, left_ids:'~0,0', right_ids:'~0,0', algorithm:'merge_left_first',     keep_dimensions:false,    hash_join_threshold:0               )" >> $OUTFILE 2>&1
iquery -aq "equi_join(right, left, left_ids:'~0,0', right_ids:'~0,0', algorithm:'merge_right_first',    keep_dimensions:false,    hash_join_threshold:0               )" >> $OUTFILE 2>&1
...
iquery -aq "sort(equi_join(left, right, left_ids:'~0', right_ids:'1', algorithm:'hash_replicate_left', keep_dimensions:false                                  ), i,a,b,c)" >> $OUTFILE 2>&1 
iquery -aq "sort(equi_join(left, right, left_ids:'~0', right_ids:'1', algorithm:'hash_replicate_right',keep_dimensions:false                                  ), i,a,b,c)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(left, right, left_ids:'~0', right_ids:'1', algorithm:'merge_left_first',    keep_dimensions:false                                  ), i,a,b,c)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(left, right, left_ids:'~0', right_ids:'1', algorithm:'merge_right_first',   keep_dimensions:false                                  ), i,a,b,c)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(left, right, left_ids:'~0', right_ids:'1', algorithm:'merge_left_first',    keep_dimensions:false,    hash_join_threshold:0      ), i,a,b,c)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(left, right, left_ids:'~0', right_ids:'1', algorithm:'merge_right_first',   keep_dimensions:false,    hash_join_threshold:0      ), i,a,b,c)" >> $OUTFILE 2>&1
...
iquery -aq "sort(equi_join(right, left, left_ids:'1', right_ids:'~0', filter:'a<>c and j>3', algorithm:'hash_replicate_left', keep_dimensions:true                          ))" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'1', right_ids:'~0', filter:'a<>c and j>3', algorithm:'hash_replicate_right',keep_dimensions:true                          ))" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'1', right_ids:'~0', filter:'a<>c and j>3', algorithm:'merge_left_first',    keep_dimensions:true                          ))" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'1', right_ids:'~0', filter:'a<>c and j>3', algorithm:'merge_right_first',   keep_dimensions:true                          ))" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'1', right_ids:'~0', filter:'a<>c and j>3', algorithm:'merge_left_first',    hash_join_threshold:0, keep_dimensions:true ))" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'1', right_ids:'~0', filter:'a<>c and j>3', algorithm:'merge_right_first',   hash_join_threshold:0, keep_dimensions:true ))" >> $OUTFILE 2>&1

echo " " >> $OUTFILE 2>&1
echo "Chapter 8" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_names:'j,c', right_names:'i , a', algorithm:'merge_left_first', keep_dimensions:false))"  >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_names:'j,c', right_ids:'~0,0', algorithm:'merge_left_first', keep_dimensions:false ))"  >> $OUTFILE 2>&1
...
iquery -aq "sort(equi_join(left, right, left_ids:'0', right_ids:'0', algorithm:'hash_replicate_right', keep_dimensions:true                            , chunk_size:1        ), a,b,d)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(left, right, left_ids:'0', right_ids:'0', algorithm:'hash_replicate_left',  keep_dimensions:true                            , chunk_size:1        ), a,b,d)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(left, right, left_ids:'0', right_ids:'0', algorithm:'merge_left_first',     keep_dimensions:true                            , chunk_size:1        ), a,b,d)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(left, right, left_ids:'0', right_ids:'0', algorithm:'merge_right_first',    keep_dimensions:true                            , chunk_size:1        ), a,b,d)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(left, right, left_ids:'0', right_ids:'0', algorithm:'merge_left_first',     keep_dimensions:true,    hash_join_threshold:0, chunk_size:1        ), a,b,d)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(left, right, left_ids:'0', right_ids:'0', algorithm:'merge_right_first',    keep_dimensions:true,    hash_join_threshold:0, chunk_size:1        ), a,b,d)" >> $OUTFILE 2>&1
...
iquery -aq "sort(equi_join(right, left, left_ids:'0', right_ids:'0', algorithm:'hash_replicate_right', keep_dimensions:true                            , chunk_size:1        ), c,d,b)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'0', right_ids:'0', algorithm:'hash_replicate_left',  keep_dimensions:true                            , chunk_size:1        ), c,d,b)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'0', right_ids:'0', algorithm:'merge_left_first',     keep_dimensions:true                            , chunk_size:1        ), c,d,b)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'0', right_ids:'0', algorithm:'merge_right_first',    keep_dimensions:true                            , chunk_size:1        ), c,d,b)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'0', right_ids:'0', algorithm:'merge_left_first',     keep_dimensions:true,    hash_join_threshold:0, chunk_size:1        ), c,d,b)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'0', right_ids:'0', algorithm:'merge_right_first',    keep_dimensions:true,    hash_join_threshold:0, chunk_size:1        ), c,d,b)" >> $OUTFILE 2>&1
...
iquery -aq "equi_join(left, right, left_ids:'0,~0', right_ids:'0,~0', algorithm:'hash_replicate_right', keep_dimensions:true                           , chunk_size:1                )" >> $OUTFILE 2>&1
iquery -aq "equi_join(left, right, left_ids:'0,~0', right_ids:'0,~0', algorithm:'hash_replicate_left',  keep_dimensions:true                           , chunk_size:1                )" >> $OUTFILE 2>&1
iquery -aq "equi_join(left, right, left_ids:'0,~0', right_ids:'0,~0', algorithm:'merge_left_first',     keep_dimensions:true                           , chunk_size:1                )" >> $OUTFILE 2>&1
iquery -aq "equi_join(left, right, left_ids:'0,~0', right_ids:'0,~0', algorithm:'merge_right_first',    keep_dimensions:true                           , chunk_size:1                )" >> $OUTFILE 2>&1
iquery -aq "equi_join(left, right, left_ids:'0,~0', right_ids:'0,~0', algorithm:'merge_left_first',     keep_dimensions:true,   hash_join_threshold:0, chunk_size:1                )" >> $OUTFILE 2>&1
iquery -aq "equi_join(left, right, left_ids:'0,~0', right_ids:'0,~0', algorithm:'merge_right_first',    keep_dimensions:true,   hash_join_threshold:0, chunk_size:1                )" >> $OUTFILE 2>&1

echo " " >> $OUTFILE 2>&1
echo "Chapter 12" >> $OUTFILE 2>&1
iquery -aq "equi_join(right, left, left_ids:'~0,0', right_ids:'~0,0'                                                                                   , chunk_size:1               )" >> $OUTFILE 2>&1
iquery -aq "equi_join(right, left, left_ids:'~0,0', right_ids:'~0,0', algorithm:'hash_replicate_right', keep_dimensions:false                            , chunk_size:1               )" >> $OUTFILE 2>&1
iquery -aq "equi_join(right, left, left_ids:'~0,0', right_ids:'~0,0', algorithm:'hash_replicate_left',  keep_dimensions:false                            , chunk_size:1               )" >> $OUTFILE 2>&1
iquery -aq "equi_join(right, left, left_ids:'~0,0', right_ids:'~0,0', algorithm:'merge_left_first',     keep_dimensions:false                            , chunk_size:1               )" >> $OUTFILE 2>&1
iquery -aq "equi_join(right, left, left_ids:'~0,0', right_ids:'~0,0', algorithm:'merge_right_first',    keep_dimensions:false                            , chunk_size:1               )" >> $OUTFILE 2>&1
iquery -aq "equi_join(right, left, left_ids:'~0,0', right_ids:'~0,0', algorithm:'merge_left_first',     keep_dimensions:false,    hash_join_threshold:0, chunk_size:1               )" >> $OUTFILE 2>&1
iquery -aq "equi_join(right, left, left_ids:'~0,0', right_ids:'~0,0', algorithm:'merge_right_first',    keep_dimensions:false,    hash_join_threshold:0, chunk_size:1               )" >> $OUTFILE 2>&1
...
iquery -aq "sort(equi_join(left, right, left_ids:'~0', right_ids:'1', algorithm:'hash_replicate_left', keep_dimensions:false                             , chunk_size:1     ), i,a,b,c)" >> $OUTFILE 2>&1 
iquery -aq "sort(equi_join(left, right, left_ids:'~0', right_ids:'1', algorithm:'hash_replicate_right',keep_dimensions:false                             , chunk_size:1     ), i,a,b,c)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(left, right, left_ids:'~0', right_ids:'1', algorithm:'merge_left_first',    keep_dimensions:false                             , chunk_size:1     ), i,a,b,c)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(left, right, left_ids:'~0', right_ids:'1', algorithm:'merge_right_first',   keep_dimensions:false                             , chunk_size:1     ), i,a,b,c)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(left, right, left_ids:'~0', right_ids:'1', algorithm:'merge_left_first',    keep_dimensions:false,    hash_join_threshold:0 , chunk_size:1     ), i,a,b,c)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(left, right, left_ids:'~0', right_ids:'1', algorithm:'merge_right_first',   keep_dimensions:false,    hash_join_threshold:0 , chunk_size:1     ), i,a,b,c)" >> $OUTFILE 2>&1
...
iquery -aq "sort(equi_join(right, left, left_ids:'1', right_ids:'~0', filter:'a<>c and j>3', algorithm:'hash_replicate_left', keep_dimensions:true      , chunk_size:1                    ))" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'1', right_ids:'~0', filter:'a<>c and j>3', algorithm:'hash_replicate_right',keep_dimensions:true      , chunk_size:1                    ))" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'1', right_ids:'~0', filter:'a<>c and j>3', algorithm:'merge_left_first',    keep_dimensions:true      , chunk_size:1                    ))" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'1', right_ids:'~0', filter:'a<>c and j>3', algorithm:'merge_right_first',   keep_dimensions:true      , chunk_size:1                    ))" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'1', right_ids:'~0', filter:'a<>c and j>3', algorithm:'merge_left_first',    hash_join_threshold:0, keep_dimensions:true, chunk_size:1 ))" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'1', right_ids:'~0', filter:'a<>c and j>3', algorithm:'merge_right_first',   hash_join_threshold:0, keep_dimensions:true, chunk_size:1 ))" >> $OUTFILE 2>&1

echo " " >> $OUTFILE 2>&1
echo "Chapter 16" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_names:'j, c', right_names:'i,a', algorithm:'merge_left_first', keep_dimensions:false, chunk_size:1))"  >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_names:' j,c ', right_ids:'~0,0', algorithm:'merge_left_first', keep_dimensions:false,  chunk_size:1 ))"  >> $OUTFILE 2>&1
...
iquery -aq "sort(equi_join(left, right, left_ids:'0', right_ids:'0', algorithm:'hash_replicate_right', keep_dimensions:true                            , chunk_size:2        ), a,b,d)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(left, right, left_ids:'0', right_ids:'0', algorithm:'hash_replicate_left',  keep_dimensions:true                            , chunk_size:2        ), a,b,d)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(left, right, left_ids:'0', right_ids:'0', algorithm:'merge_left_first',     keep_dimensions:true                            , chunk_size:2        ), a,b,d)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(left, right, left_ids:'0', right_ids:'0', algorithm:'merge_right_first',    keep_dimensions:true                            , chunk_size:2        ), a,b,d)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(left, right, left_ids:'0', right_ids:'0', algorithm:'merge_left_first',     keep_dimensions:true,    hash_join_threshold:0, chunk_size:2        ), a,b,d)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(left, right, left_ids:'0', right_ids:'0', algorithm:'merge_right_first',    keep_dimensions:true,    hash_join_threshold:0, chunk_size:2        ), a,b,d)" >> $OUTFILE 2>&1
...
iquery -aq "sort(equi_join(right, left, left_ids:'0', right_ids:'0', algorithm:'hash_replicate_right', keep_dimensions:true                            , chunk_size:2        ), c,d,b)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'0', right_ids:'0', algorithm:'hash_replicate_left',  keep_dimensions:true                            , chunk_size:2        ), c,d,b)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'0', right_ids:'0', algorithm:'merge_left_first',     keep_dimensions:true                            , chunk_size:2        ), c,d,b)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'0', right_ids:'0', algorithm:'merge_right_first',    keep_dimensions:true                            , chunk_size:2        ), c,d,b)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'0', right_ids:'0', algorithm:'merge_left_first',     keep_dimensions:true,    hash_join_threshold:0, chunk_size:2        ), c,d,b)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'0', right_ids:'0', algorithm:'merge_right_first',    keep_dimensions:true,    hash_join_threshold:0, chunk_size:2        ), c,d,b)" >> $OUTFILE 2>&1
...
iquery -aq "equi_join(left, right, left_ids:'0,~0', right_ids:'0,~0', algorithm:'hash_replicate_right', keep_dimensions:true                           , chunk_size:2                )" >> $OUTFILE 2>&1
iquery -aq "equi_join(left, right, left_ids:'0,~0', right_ids:'0,~0', algorithm:'hash_replicate_left',  keep_dimensions:true                           , chunk_size:2                )" >> $OUTFILE 2>&1
iquery -aq "equi_join(left, right, left_ids:'0,~0', right_ids:'0,~0', algorithm:'merge_left_first',     keep_dimensions:true                           , chunk_size:2                )" >> $OUTFILE 2>&1
iquery -aq "equi_join(left, right, left_ids:'0,~0', right_ids:'0,~0', algorithm:'merge_right_first',    keep_dimensions:true                           , chunk_size:2                )" >> $OUTFILE 2>&1
iquery -aq "equi_join(left, right, left_ids:'0,~0', right_ids:'0,~0', algorithm:'merge_left_first',     keep_dimensions:true,   hash_join_threshold:0, chunk_size:2                )" >> $OUTFILE 2>&1
iquery -aq "equi_join(left, right, left_ids:'0,~0', right_ids:'0,~0', algorithm:'merge_right_first',    keep_dimensions:true,   hash_join_threshold:0, chunk_size:2                )" >> $OUTFILE 2>&1

echo " " >> $OUTFILE 2>&1
echo "Chapter 20" >> $OUTFILE 2>&1
iquery -aq "equi_join(right, left, left_ids:'~0,0', right_ids:'~0,0'                                                                                   , chunk_size:2               )" >> $OUTFILE 2>&1
iquery -aq "equi_join(right, left, left_ids:'~0,0', right_ids:'~0,0', algorithm:'hash_replicate_right', keep_dimensions:false                            , chunk_size:2               )" >> $OUTFILE 2>&1
iquery -aq "equi_join(right, left, left_ids:'~0,0', right_ids:'~0,0', algorithm:'hash_replicate_left',  keep_dimensions:false                            , chunk_size:2               )" >> $OUTFILE 2>&1
iquery -aq "equi_join(right, left, left_ids:'~0,0', right_ids:'~0,0', algorithm:'merge_left_first',     keep_dimensions:false                            , chunk_size:2               )" >> $OUTFILE 2>&1
iquery -aq "equi_join(right, left, left_ids:'~0,0', right_ids:'~0,0', algorithm:'merge_right_first',    keep_dimensions:false                            , chunk_size:2               )" >> $OUTFILE 2>&1
iquery -aq "equi_join(right, left, left_ids:'~0,0', right_ids:'~0,0', algorithm:'merge_left_first',     keep_dimensions:false,    hash_join_threshold:0, chunk_size:2               )" >> $OUTFILE 2>&1
iquery -aq "equi_join(right, left, left_ids:'~0,0', right_ids:'~0,0', algorithm:'merge_right_first',    keep_dimensions:false,    hash_join_threshold:0, chunk_size:2               )" >> $OUTFILE 2>&1
...
iquery -aq "sort(equi_join(left, right, left_ids:'~0', right_ids:'1', algorithm:'hash_replicate_left', keep_dimensions:false                             , chunk_size:2     ), i,a,b,c)" >> $OUTFILE 2>&1 
iquery -aq "sort(equi_join(left, right, left_ids:'~0', right_ids:'1', algorithm:'hash_replicate_right',keep_dimensions:false                             , chunk_size:2     ), i,a,b,c)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(left, right, left_ids:'~0', right_ids:'1', algorithm:'merge_left_first',    keep_dimensions:false                             , chunk_size:2     ), i,a,b,c)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(left, right, left_ids:'~0', right_ids:'1', algorithm:'merge_right_first',   keep_dimensions:false                             , chunk_size:2     ), i,a,b,c)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(left, right, left_ids:'~0', right_ids:'1', algorithm:'merge_left_first',    keep_dimensions:false,    hash_join_threshold:0 , chunk_size:2     ), i,a,b,c)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(left, right, left_ids:'~0', right_ids:'1', algorithm:'merge_right_first',   keep_dimensions:false,    hash_join_threshold:0 , chunk_size:2     ), i,a,b,c)" >> $OUTFILE 2>&1
...
iquery -aq "sort(equi_join(right, left, left_ids:'1', right_ids:'~0', filter:'a<>c and j>3', algorithm:'hash_replicate_left', keep_dimensions:true      , chunk_size:2                    ))" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'1', right_ids:'~0', filter:'a<>c and j>3', algorithm:'hash_replicate_right',keep_dimensions:true      , chunk_size:2                    ))" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'1', right_ids:'~0', filter:'a<>c and j>3', algorithm:'merge_left_first',    keep_dimensions:true      , chunk_size:2                    ))" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'1', right_ids:'~0', filter:'a<>c and j>3', algorithm:'merge_right_first',   keep_dimensions:true      , chunk_size:2                    ))" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'1', right_ids:'~0', filter:'a<>c and j>3', algorithm:'merge_left_first',    hash_join_threshold:0, keep_dimensions:true, chunk_size:2 ))" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'1', right_ids:'~0', filter:'a<>c and j>3', algorithm:'merge_right_first',   hash_join_threshold:0, keep_dimensions:true, chunk_size:2 ))" >> $OUTFILE 2>&1

echo " " >> $OUTFILE 2>&1
echo "Chapter 24" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_names:'j,c', right_names:'i,a', algorithm:'merge_left_first', keep_dimensions:false, chunk_size:2))"  >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_names:'j,c', right_ids:'~0,0', algorithm:'merge_left_first', keep_dimensions:false,  chunk_size:2 ))"  >> $OUTFILE 2>&1
...
iquery -aq "sort(equi_join(right, left, left_ids:'~0,0', right_ids:'~0,0', left_outer:true, keep_dimensions:true),j,c,d)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'~0,0', right_ids:'~0,0', left_outer:true, keep_dimensions:true, algorithm:'hash_replicate_right'),j,c,d)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'~0,0', right_ids:'~0,0', left_outer:true, keep_dimensions:true, algorithm:'merge_left_first'),j,c,d)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'~0,0', right_ids:'~0,0', left_outer:true, keep_dimensions:true, algorithm:'merge_right_first'),j,c,d)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'~0,0', right_ids:'~0,0', left_outer:true, keep_dimensions:true, algorithm:'merge_left_first', hash_join_threshold:0),j,c,d)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'~0,0', right_ids:'~0,0', left_outer:true, keep_dimensions:true, algorithm:'merge_right_first', hash_join_threshold:0),j,c,d)" >> $OUTFILE 2>&1

echo " " >> $OUTFILE 2>&1
echo "Chapter 28" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'~0,0', right_ids:'~0,0', right_outer:true, keep_dimensions:true),j,c)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'~0,0', right_ids:'~0,0', right_outer:true, keep_dimensions:true, algorithm:'hash_replicate_left'),j,c)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'~0,0', right_ids:'~0,0', right_outer:true, keep_dimensions:true, algorithm:'merge_left_first'),j,c)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'~0,0', right_ids:'~0,0', right_outer:true, keep_dimensions:true, algorithm:'merge_right_first'),j,c)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'~0,0', right_ids:'~0,0', right_outer:true, keep_dimensions:true, algorithm:'merge_left_first', hash_join_threshold:0),j,c)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(right, left, left_ids:'~0,0', right_ids:'~0,0', right_outer:true, keep_dimensions:true, algorithm:'merge_right_first', hash_join_threshold:0),j,c)" >> $OUTFILE 2>&1

echo " " >> $OUTFILE 2>&1
echo "Chapter 29" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(left, right, left_ids:'0,~0', right_ids:'0,1', left_outer:true, right_outer:true, keep_dimensions:true, algorithm:'merge_right_first'), a, i,b)" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(left, right, left_ids:'0,~0', right_ids:'0,1', left_outer:true, right_outer:true, keep_dimensions:true, algorithm:'merge_left_first'), a, i,b)" >> $OUTFILE 2>&1

echo " " >> $OUTFILE 2>&1
echo "Chapter 30" >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(left, right, left_names:'i ', right_names:'j', left_outer:true, right_outer:true, out_names:'uv,w,x,y_,z'), uv)" >> $OUTFILE 2>&1 
iquery -aq "sort(equi_join(left, right, left_names:'i', right_names:'j', left_outer:true, right_outer:true, algorithm:'merge_left_first'),  i)"  >> $OUTFILE 2>&1
iquery -aq "sort(equi_join(left, right, left_names:'i', right_names:'j', left_outer:true, right_outer:true, algorithm:'merge_right_first'), i)"  >> $OUTFILE 2>&1
